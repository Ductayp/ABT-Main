...
local newSent = script:FindFirstChild("Sent")
if not newSent then
	newSent = Instance.new("RemoteEvent")
	newSent.Name = "Sent"
	newSent.Parent = script
end
local newReceived = script:FindFirstChild("Received")
if not newReceived then
	newReceived = Instance.new("RemoteEvent")
	newReceived.Name = "Received"
	newReceived.Parent = script
end
