...
-- Modified for use in ZonePlusFolder
...
local ZonePlusFolder = replicatedStorage.GameFiles.Shared:WaitForChild("ZonePlus")
local Promise = require(ZonePlusFolder:WaitForChild("Promise"))
