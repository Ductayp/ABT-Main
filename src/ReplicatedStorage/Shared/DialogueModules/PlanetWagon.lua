...
module.Stage.QuickTutorial4 = {
    IconName = "Icon_PlanetWagon",
    Title = "PlanetWagon (A.K.A. Planet_Dad)",
    Body = "EACH and EVERY stand has 3 rarity versions: Common, Rare and Legendary. Each does more damage than the last and looks different.<br/><br/><b>Talk to Enrico at his shop for more info.</b>",
    Choice_1 = {
        Display = true,
        Text = "Wow! Then what?",
        CustomProperties = {Size = UDim2.new(0.4, 0, 0.9, 0)},
...
module.Stage.QuickTutorial5 = {
    IconName = "Icon_PlanetWagon",
    Title = "PlanetWagon (A.K.A. Planet_Dad)",
    Body = "If you need to remove your stand, you can SACFRICICE it or STORE it at Enrico's Shop.<br/><br/><b>You really should go visit the place, its just down the road by the Harbor!!!</b>",
    Choice_1 = {
        Display = true,
