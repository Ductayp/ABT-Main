...
local ZonePlusFolder = replicatedStorage.GameFiles.Shared:WaitForChild("ZonePlus") -- modified by pdab to fit our directroy framework
local Signal = require(ZonePlusFolder:WaitForChild("Signal")) -- modified by pdab to fit our directroy framework
local Maid = require(ZonePlusFolder:WaitForChild("Maid")) -- modified by pdab to fit our directroy framework
local Zone = {}
Zone.__index = Zone
